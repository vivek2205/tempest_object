...
class ObjectTestACLs(base.BaseObjectTest):
    ...
    @test.skip_because(bug='1',reason='setting ACL to particular user is not working but only .r:*')
    ...
    @test.skip_because(bug='1',reason='setting ACL to particular user is not working but only .w:*')
    @test.attr(type='smoke')
