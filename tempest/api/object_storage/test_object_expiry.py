...
class ObjectExpiryTest(base.BaseObjectTest):
    ...
    @test.skip_because(bug='1',reason='posting x-delete-after metadata is not working')
    @test.attr(type='gate')
    ...
    @test.skip_because(bug='1',reason='posting x-delete-at metadata is not working')
    @test.attr(type='gate')
